...
export default function () {
    ...
    h.entityText = function (s) {
        ...
        pray(
            ...
            val instanceof DocumentFragment && val.childNodes.length === 1 && val.childNodes[0] instanceof Text
        );
    ...
    function closest(el, s) {
        ...
        do {
            ...
            match =
                (_c =
                    (_b = match === null || match === void 0 ? void 0 : match.parentElement) !== null && _b !== void 0
                        ? _b
        ...
        Aria.prototype.queue = function (item, shouldDescribe) {
            ...
            if (item instanceof MQNode) {
                ...
                if (shouldDescribe) {
                    ...
                    if (item.parent && item.parent.ariaLabel && item.ariaLabel === "block") {
    ...
    var DOMFragment = /** @class */ (function () {
        ...
        DOMFragment.prototype.next = function () {
            ...
            while (current) {
                current = current.nextSibling;
                if (current && current.nodeType === Node.ELEMENT_NODE) return new DOMFragment(current);
            }
    ...
    var NodeBase = /** @class */ (function () {
        ...
        NodeBase.getNodeOfElement = function (el) {
            if (!el) return;
            if (!el.nodeType) throw new Error("must pass an Element to NodeBase.getNodeOfElement");
        ...
        NodeBase.prototype.shouldIgnoreSubstitutionInSimpleSubscript = function (options) {
            ...
            if (!this.parent.domFrag().hasClass("dcg-mq-sub")) return false;
            return true;
        };
    ...
    var Cursor = /** @class */ (function (_super) {
        ...
        function Cursor(initParent, options, controller) {
             ...
             */
            _this_1.upDownCache = {};
            _this_1.cursorElement = h("span", { class: "dcg-mq-cursor" }, [h.text(U_ZERO_WIDTH_SPACE)]);
            ...
            _this_1.blink = function () {
                domFrag(_this_1.cursorElement).toggleClass("dcg-mq-blink");
            };
            return _this_1;
        }
        ...
        Cursor.prototype.show = function () {
            domFrag(this.cursorElement).removeClass("dcg-mq-blink");
        ...
        Cursor.prototype.getBoundingClientRectWithoutMargin = function () {
            ...
            frag.removeClass("dcg-mq-cursor");
            var _c = getBoundingClientRect(frag.oneElement()),
                left = _c.left,
                right = _c.right;
            frag.addClass("dcg-mq-cursor");
            return {
                left: left,
                right: right,
            };
    ...
    var MQSelection = /** @class */ (function (_super) {
        ...
        function MQSelection(withDir, oppDir, dir) {
            ...
            _this_1._el = h("span", { class: "dcg-mq-selection" });
    ...
    function getInterface(v) {
        ...
        var AbstractMathQuill = /** @class */ (function (_super) {
            ...
            AbstractMathQuill.prototype.mathquillify = function (classNames) {
                ...
                root.setDOM(
                    domFrag(h("span", { class: "dcg-mq-root-block", "aria-hidden": true }))
                        .appendTo(el)
                        .oneElement()
                );
                ...
                this.revert = function () {
                    ...
                    domFrag(el)
                        .removeClass("dcg-mq-editable-field dcg-mq-math-mode dcg-mq-text-mode")
                        .empty()
                        .append(contents);
            ...
            AbstractMathQuill.prototype.html = function () {
                return this.__controller.root
                    ...
                    .replace(/<span class="?dcg-mq-cursor( dcg-mq-blink)?"?>.?<\/span>/i, "")
        ...
        var MQ = function (el) {
            ...
            for (var _i = 0, childArray_1 = childArray; _i < childArray_1.length; _i++) {
                ...
                if (child.classList.contains("dcg-mq-root-block")) {
                    blockElement = child;
                    break;
                }
            }
    ...
    var Controller_focusBlur = /** @class */ (function (_super) {
        ...
        function Controller_focusBlur() {
            ...
            _this_1.handleTextareaFocusEditable = function () {
                ...
                domFrag(_this_1.container).addClass("dcg-mq-focused");
                if (!cursor.parent) cursor.insAtRightEnd(_this_1.root);
                if (cursor.selection) {
                    cursor.selection.domFrag().removeClass("dcg-mq-blur");
            ...
            _this_1.handleWindowBlur = function () {
                ...
                if (_this_1.cursor.selection) _this_1.cursor.selection.domFrag().addClass("dcg-mq-blur");
                _this_1.blur();
                _this_1.updateMathspeak();
            };
            return _this_1;
        ...
        Controller_focusBlur.prototype.disableGroupingForSeconds = function (seconds) {
            ...
            if (seconds === 0) {
                this.root.domFrag().removeClass("dcg-mq-suppress-grouping");
            } else {
                this.root.domFrag().addClass("dcg-mq-suppress-grouping");
                this.__disableGroupingTimeout = setTimeout(function () {
                    _this_1.root.domFrag().removeClass("dcg-mq-suppress-grouping");
                }, seconds * 1000);
            }
        };
        Controller_focusBlur.prototype.blur = function () {
            ...
            domFrag(this.container).removeClass("dcg-mq-focused"); // clearing/blurring selection
    ...
    var Controller_keystroke = /** @class */ (function (_super) {
        ...
        Controller_keystroke.prototype.escapeDir = function (dir, _key, e) {
            ...
            if (cursor.parent !== this.root) e === null || e === void 0 ? void 0 : e.preventDefault();
        ...
        Controller_keystroke.prototype.deleteDir = function (dir) {
            ...
            if (cursorEl && cursorEl instanceof MQNode) {
                if (cursorEl.sides) {
                    ctrlr.aria.queue(
                        cursorEl.parent.chToCmd(cursorEl.sides[-dir].ch).mathspeak({ createdLeftOf: cursor })
                    );
                ...
                if (cursorElParent.sides) {
                    ctrlr.aria.queue(
                        cursorElParent.parent.chToCmd(cursorElParent.sides[dir].ch).mathspeak({ createdLeftOf: cursor })
                    );
        ...
        Controller_keystroke.prototype.selectDirIncremental = function (dir) {
            ...
            if (node) {
                ...
                if (seln && seln.getEnd(dir) === node && cursor.anticursor[-dir] !== node) {
    ...
    var Controller_latex = /** @class */ (function (_super) {
        ...
        Controller_latex.prototype.renderLatexMath = function (latex) {
            ...
            if (!root.getEnd(L) || !root.getEnd(R) || oldLatex !== latex) {
                this.updateLatexMathEfficiently(latex, oldLatex) || this.renderLatexMathFromScratch(latex);
                this.updateMathspeak();
            }
            cursor.insAtRightEnd(root);
        };
    ...
    var Controller_mouse = /** @class */ (function (_super) {
        ...
        function Controller_mouse() {
            ...
            _this_1.handleMouseDown = function (e) {
                var rootElement = closest(e.target, ".dcg-mq-root-block");
                var root =
    ...
    var Controller_scrollHoriz = /** @class */ (function (_super) {
        ...
        Controller_scrollHoriz.prototype.setOverflowClasses = function () {
            ...
            if (root.classList.contains("dcg-mq-editing-overflow-right") !== shouldHaveOverflowRight)
                root.classList.toggle("dcg-mq-editing-overflow-right");
            if (root.classList.contains("dcg-mq-editing-overflow-left") !== shouldHaveOverflowLeft)
                root.classList.toggle("dcg-mq-editing-overflow-left");
        };
    ...
    var Controller = /** @class */ (function (_super) {
        ...
        Controller.prototype.createTextarea = function () {
            this.textareaSpan = h("span", { class: "dcg-mq-textarea" });
        ...
        Controller.prototype.setupStaticField = function () {
            this.mathspeakSpan = h("span", { class: "dcg-mq-mathspeak" });
        ...
        Controller.prototype.updateMathspeak = function () {
            ...
            var labelWithSuffix = /[A-Za-z0-9]$/.test(ariaLabel) ? ariaLabel + ":" : ariaLabel;
            ...
            if (!!ctrlr.mathspeakSpan) {
                ...
                ctrlr.mathspeakSpan.textContent = (labelWithSuffix + " " + mathspeak).trim();
            } else {
    ...
    var BinaryOperator = /** @class */ (function (_super) {
        ...
        function BinaryOperator(ctrlSeq, html, text, mathspeak, treatLikeSymbol) {
            ...
            if (treatLikeSymbol) {
                _this_1 =
                    _super.call(this, ctrlSeq, h("span", {}, [html || h.text(ctrlSeq || "")]), undefined, mathspeak) ||
                    this;
            } else {
                _this_1 =
                    _super.call(
                        this,
                        ctrlSeq,
                        h("span", { class: "dcg-mq-binary-operator" }, html ? [html] : []),
                        text,
                        mathspeak
                    ) || this;
            }
    ...
    var MathBlock = /** @class */ (function (_super) {
        ...
        MathBlock.prototype.seek = function (clientX, cursor) {
            ...
            var endsL = this.getEnd(L);
            if (clientX < getBoundingClientRect(endsL.domFrag().oneElement()).left) return cursor.insAtLeftEnd(this);
            while (clientX < getBoundingClientRect(node.domFrag().oneElement()).left) node = node[L];
        ...
        MathBlock.prototype.chToCmd = function (ch, options) {
            ...
            else if (options && options.typingPercentWritesPercentOf && ch === "%") return LatexCmds.percentof(ch);
        ...
        MathBlock.prototype.focus = function () {
            this.domFrag().addClass("dcg-mq-hasCursor");
            this.domFrag().removeClass("dcg-mq-empty");
            return this;
        };
        MathBlock.prototype.blur = function (cursor) {
            this.domFrag().removeClass("dcg-mq-hasCursor");
            if (this.isEmpty()) {
        ...
        return (
            (_c = /** @class */ (function (_super) {
                ...
                StaticMath.prototype.__mathquillify = function (opts, _interfaceVersion) {
                    this.config(opts);
                    _super.prototype.mathquillify.call(this, "dcg-mq-math-mode");
        ...
        return (
            (_c = /** @class */ (function (_super) {
                ...
                MathField.prototype.__mathquillify = function (opts, interfaceVersion) {
                    ...
                    _super.prototype.mathquillify.call(this, "dcg-mq-editable-field dcg-mq-math-mode");
    ...
    API.InnerMathField = function (APIClasses) {
        ...
        return /** @class */ (function (_super) {
            ...
            class_1.prototype.makeStatic = function () {
                ...
                domFrag(this.__controller.container).removeClass("dcg-mq-editable-field");
            };
            class_1.prototype.makeEditable = function () {
                this.__controller.editable = true;
                this.__controller.editablesTextareaEvents();
                this.__controller.cursor.insAtRightEnd(this.__controller.root);
                domFrag(this.__controller.container).addClass("dcg-mq-editable-field");
            };
            return class_1;
    ...
    var TextBlock = /** @class */ (function (_super) {
        ...
        TextBlock.prototype.latexRecursive = function (ctx) {
            ...
            if (contents.length > 0) {
                ctx.latex += this.ctrlSeq + "{";
                ctx.latex += contents.replace(/\\/g, "\\backslash ").replace(/[{}]/g, "\\$&");
                ctx.latex += "}";
            }
            this.checkCursorContextClose(ctx);
        };
        TextBlock.prototype.html = function () {
            var out = h("span", { class: "dcg-mq-text-mode" }, [h.text(this.textContents())]);
            this.setDOM(out);
    ...
    LatexCmds.em = LatexCmds.italic = LatexCmds.italics = LatexCmds.emph = LatexCmds.textit = LatexCmds.textsl = makeTextBlock(
        ...
        "Italic",
        "i",
        { class: "dcg-mq-text-mode" }
    );
    LatexCmds.strong = LatexCmds.bold = LatexCmds.textbf = makeTextBlock("\\textbf", "Bold", "b", {
        class: "dcg-mq-text-mode",
    });
    LatexCmds.sf = LatexCmds.textsf = makeTextBlock("\\textsf", "Sans serif font", "span", {
        class: "dcg-mq-sans-serif dcg-mq-text-mode",
    });
    LatexCmds.tt = LatexCmds.texttt = makeTextBlock("\\texttt", "Mono space font", "span", {
        class: "dcg-mq-monospace dcg-mq-text-mode",
    });
    ...
    var RootMathCommand = /** @class */ (function (_super) {
        ...
        function RootMathCommand(cursor) {
            ...
            _this_1.domView = new DOMView(1, function (blocks) {
                return h.block("span", { class: "dcg-mq-math-mode" }, blocks[0]);
            });
        ...
        return (
            (_c = /** @class */ (function (_super) {
                ...
                TextField.prototype.__mathquillify = function () {
                    _super.prototype.mathquillify.call(this, "dcg-mq-editable-field dcg-mq-text-mode");
                    return this;
                };
     ...
     ***********************************/
    LatexCmds.notin = LatexCmds.cong = LatexCmds.equiv = LatexCmds.oplus = LatexCmds.otimes = function (latex) {
        return new BinaryOperator("\\" + latex + " ", h.entityText("&" + latex + ";"));
    };
    LatexCmds["\u2217"] = LatexCmds.ast = LatexCmds.star = LatexCmds.loast = LatexCmds.lowast = bindBinaryOperator(
        "\\ast ",
        "&lowast;",
        "low asterisk"
    );
    ...
    LatexCmds["\u2248"] = LatexCmds.asymp = LatexCmds.approx = bindBinaryOperator(
        "\\approx ",
        "&asymp;",
    ...
    LatexCmds.notni = LatexCmds.niton = LatexCmds.notcontains = LatexCmds.doesnotcontain = bindBinaryOperator(
        "\\not\\ni ",
        "&#8716;",
        "does not contain"
    );
    LatexCmds.sub = LatexCmds.subset = bindBinaryOperator("\\subset ", "&sub;", "subset");
    LatexCmds.sup = LatexCmds.supset = LatexCmds.superset = bindBinaryOperator("\\supset ", "&sup;", "superset");
    LatexCmds.nsub = LatexCmds.notsub = LatexCmds.nsubset = LatexCmds.notsubset = bindBinaryOperator(
        "\\not\\subset ",
        "&#8836;",
        "not a subset"
    );
    LatexCmds.nsup = LatexCmds.notsup = LatexCmds.nsupset = LatexCmds.notsupset = LatexCmds.nsuperset = LatexCmds.notsuperset = bindBinaryOperator(
        "\\not\\supset ",
        "&#8837;",
        "not a superset"
    );
    LatexCmds.sube = LatexCmds.subeq = LatexCmds.subsete = LatexCmds.subseteq = bindBinaryOperator(
        "\\subseteq ",
        "&sube;",
        "subset or equal to"
    );
    LatexCmds.supe = LatexCmds.supeq = LatexCmds.supsete = LatexCmds.supseteq = LatexCmds.supersete = LatexCmds.superseteq = bindBinaryOperator(
        "\\supseteq ",
        "&supe;",
        "superset or equal to"
    );
    LatexCmds.nsube = LatexCmds.nsubeq = LatexCmds.notsube = LatexCmds.notsubeq = LatexCmds.nsubsete = LatexCmds.nsubseteq = LatexCmds.notsubsete = LatexCmds.notsubseteq = bindBinaryOperator(
        "\\not\\subseteq ",
        "&#8840;",
        "not subset or equal to"
    );
    LatexCmds.nsupe = LatexCmds.nsupeq = LatexCmds.notsupe = LatexCmds.notsupeq = LatexCmds.nsupsete = LatexCmds.nsupseteq = LatexCmds.notsupsete = LatexCmds.notsupseteq = LatexCmds.nsupersete = LatexCmds.nsuperseteq = LatexCmds.notsupersete = LatexCmds.notsuperseteq = bindBinaryOperator(
        "\\not\\supseteq ",
        "&#8841;",
    ...
    LatexCmds.N = LatexCmds.naturals = LatexCmds.Naturals = bindVanillaSymbol("\\mathbb{N}", "&#8469;", "naturals");
    LatexCmds.P = LatexCmds.primes = LatexCmds.Primes = LatexCmds.projective = LatexCmds.Projective = LatexCmds.probability = LatexCmds.Probability = bindVanillaSymbol(
        "\\mathbb{P}",
        "&#8473;",
        "P"
    );
    LatexCmds.Z = LatexCmds.integers = LatexCmds.Integers = bindVanillaSymbol("\\mathbb{Z}", "&#8484;", "integers");
    LatexCmds.Q = LatexCmds.rationals = LatexCmds.Rationals = bindVanillaSymbol("\\mathbb{Q}", "&#8474;", "rationals");
    LatexCmds.R = LatexCmds.reals = LatexCmds.Reals = bindVanillaSymbol("\\mathbb{R}", "&#8477;", "reals");
    LatexCmds.C = LatexCmds.complex = LatexCmds.Complex = LatexCmds.complexes = LatexCmds.Complexes = LatexCmds.complexplane = LatexCmds.Complexplane = LatexCmds.ComplexPlane = bindVanillaSymbol(
        "\\mathbb{C}",
        "&#8450;",
        "complexes"
    );
    LatexCmds.H = LatexCmds.Hamiltonian = LatexCmds.quaternions = LatexCmds.Quaternions = bindVanillaSymbol(
        "\\mathbb{H}",
        "&#8461;",
        "quaternions"
    );
    ...
    */
    ...
    LatexCmds.AA = LatexCmds.Angstrom = LatexCmds.angstrom = bindVanillaSymbol("\\text\\AA ", "&#8491;", "AA");
    LatexCmds.ring = LatexCmds.circ = LatexCmds.circle = bindVanillaSymbol("\\circ ", "&#8728;", "circle");
    ...
    LatexCmds.not = LatexCmds["\u00ac"] = LatexCmds.neg = bindVanillaSymbol("\\neg ", "&not;", "not"); //bind(MQSymbol,'\\not ','<span class="not">/</span>', 'not');
    LatexCmds[
        "\u2026"
    ] = LatexCmds.dots = LatexCmds.ellip = LatexCmds.hellip = LatexCmds.ellipsis = LatexCmds.hellipsis = bindVanillaSymbol(
        "\\dots ",
        "&hellip;",
        "ellipsis"
    );
    LatexCmds.converges = LatexCmds.darr = LatexCmds.dnarr = LatexCmds.dnarrow = LatexCmds.downarrow = bindVanillaSymbol(
        "\\downarrow ",
        "&darr;",
        "converges with"
    );
    LatexCmds.dArr = LatexCmds.dnArr = LatexCmds.dnArrow = LatexCmds.Downarrow = bindVanillaSymbol(
        "\\Downarrow ",
        "&dArr;",
        "down arrow"
    );
    LatexCmds.diverges = LatexCmds.uarr = LatexCmds.uparrow = bindVanillaSymbol(
        "\\uparrow ",
        "&uarr;",
        "diverges from"
    );
    ...
    LatexCmds.lArr = LatexCmds.Leftarrow = bindVanillaSymbol("\\Leftarrow ", "&lArr;", "left arrow");
    LatexCmds.harr = LatexCmds.lrarr = LatexCmds.leftrightarrow = bindVanillaSymbol(
        "\\leftrightarrow ",
        "&harr;",
    ...
    LatexCmds.Im = LatexCmds.imag = LatexCmds.image = LatexCmds.imagin = LatexCmds.imaginary = LatexCmds.Imaginary = bindVanillaSymbol(
        "\\Im ",
        "&image;",
        "imaginary"
    );
    ...
    LatexCmds.alef = LatexCmds.alefsym = LatexCmds.aleph = LatexCmds.alephsym = bindVanillaSymbol(
        "\\aleph ",
        "&alefsym;",
        "alef sym"
    );
    LatexCmds.xist = LatexCmds.xists = LatexCmds.exist = LatexCmds.exists = bindVanillaSymbol(
        //LOL
        "\\exists ",
        "&exist;",
    ...
    LatexCmds.and = LatexCmds.land = LatexCmds.wedge = bindBinaryOperator("\\wedge ", "&and;", "and");
    LatexCmds.or = LatexCmds.lor = LatexCmds.vee = bindBinaryOperator("\\vee ", "&or;", "or");
    LatexCmds.o = LatexCmds.O = LatexCmds.empty = LatexCmds.emptyset = LatexCmds.oslash = LatexCmds.Oslash = LatexCmds.nothing = LatexCmds.varnothing = bindBinaryOperator(
        "\\varnothing ",
        "&empty;",
        "nothing"
    );
    LatexCmds.cup = LatexCmds.union = bindBinaryOperator("\\cup ", "&cup;", "union");
    LatexCmds.cap = LatexCmds.intersect = LatexCmds.intersection = bindBinaryOperator(
        "\\cap ",
        "&cap;",
        "intersection"
    );
            ...
            while (node) {
                ...
                if (totalDigits >= 4) {
                    if (count === totalDigits) {
                        cls = "dcg-mq-group-leading-" + numDigitsInFirstGroup;
                    } else if (count % 3 === 0) {
                        if (count !== totalDigits) {
    ...
    var Digit = /** @class */ (function (_super) {
        ...
        function Digit(ch, mathspeak) {
            return (
                _super.call(this, ch, h("span", { class: "dcg-mq-digit" }, [h.text(ch)]), undefined, mathspeak) || this
            );
        }
        Digit.prototype.createLeftOf = function (cursor) {
            var cursorL = cursor[L];
            var cursorLL = cursorL && cursorL[L];
            var cursorParentParentSub = cursor.parent.parent instanceof SupSub ? cursor.parent.parent.sub : undefined;
            if (
                ...
                ((cursorL instanceof Variable && cursorL.isItalic !== false) ||
                    (cursorL instanceof SupSub && cursorLL instanceof Variable && cursorLL.isItalic !== false))
            ) {
        ...
        Digit.prototype.mathspeak = function (opts) {
            if (opts && opts.createdLeftOf) {
                ...
                var cursorParentParentSub =
                    cursor.parent.parent instanceof SupSub ? cursor.parent.parent.sub : undefined;
                if (
                    cursor.options.autoSubscriptNumerals &&
                    cursor.parent !== cursorParentParentSub &&
                    ((cursorL instanceof Variable && cursorL.isItalic !== false) ||
                        (cursor[L] instanceof SupSub && cursorLL instanceof Variable && cursorLL.isItalic !== false))
                ) {
    ...
    var Letter = /** @class */ (function (_super) {
        ...
        Letter.prototype.italicize = function (bool) {
            ...
            this.domFrag().toggleClass("dcg-mq-operator-name", !bool);
            return this;
        };
        ...
        Letter.prototype.autoUnItalicize = function (opts) {
            ...
            new Fragment(lR || this.parent.getEnd(L), rL || this.parent.getEnd(R)).each(function (el) {
                if (el instanceof Letter) {
                    el.italicize(true).domFrag().removeClass("dcg-mq-first dcg-mq-last dcg-mq-followed-by-supsub");
                ...
                for (var len = min(autoOpsLength, str.length - i); len > 0; len -= 1) {
                    ...
                    if (autoOps.hasOwnProperty(word)) {
                        ...
                        if (TwoWordOpNames.hasOwnProperty(word)) {
                            ...
                            lastLLL.domFrag().addClass("dcg-mq-last");
                        }
                        if (!this.shouldOmitPadding(first[L])) first.domFrag().addClass("dcg-mq-first");
                        if (!this.shouldOmitPadding(last[R])) {
                            if (last[R] instanceof SupSub) {
                                ...
                                var respace = (supsub.siblingCreated = supsub.siblingDeleted = function () {
                                    supsub
                                        .domFrag()
                                        .toggleClass("dcg-mq-after-operator-name", !(supsub[R] instanceof Bracket));
                                });
                                respace();
                            } else {
                                last.domFrag().toggleClass("dcg-mq-last", !(last[R] instanceof Bracket));
                            }
                        }
                        i += len - 1;
                        first = last;
    ...
    LatexCmds.f = /** @class */ (function (_super) {
        ...
        function class_5() {
            ...
            _this_1.domView = new DOMView(0, function () {
                return h("var", { class: "dcg-mq-f" }, [h.text("f")]);
            });
            return _this_1;
        }
        class_5.prototype.italicize = function (bool) {
            ...
            this.domFrag().toggleClass("dcg-mq-f", bool);
    ...
    LatexCmds["."] = function () {
        return new DigitGroupingChar(".", h("span", { class: "dcg-mq-digit" }, [h.text(".")]), ".");
    };
    ...
    LatexCmds.alpha = LatexCmds.beta = LatexCmds.gamma = LatexCmds.delta = LatexCmds.zeta = LatexCmds.eta = LatexCmds.theta = LatexCmds.iota = LatexCmds.kappa = LatexCmds.mu = LatexCmds.nu = LatexCmds.xi = LatexCmds.rho = LatexCmds.sigma = LatexCmds.tau = LatexCmds.chi = LatexCmds.psi = LatexCmds.omega = function (
        latex
    ) {
    ...
    LatexCmds.sigmaf = LatexCmds.sigmav = LatexCmds.varsigma = bindVariable("\\varsigma ", "&sigmaf;", "sigma"); //W3C/Unicode //Elsevier //LaTeX
    LatexCmds.thetav = LatexCmds.vartheta = LatexCmds.thetasym = bindVariable("\\vartheta ", "&thetasym;", "theta"); //Elsevier and 9573-13 //AMS and LaTeX //W3C/Unicode
    ...
    LatexCmds.gammad = LatexCmds.Gammad = LatexCmds.digamma = bindVariable("\\digamma ", "&#989;", "gamma"); //Elsevier //9573-13 -- WTF, right? I dunno if this was a typo in the reference (see above) //LaTeX
    ...
    LatexCmds.Upsilon = LatexCmds.Upsi = LatexCmds.upsih = LatexCmds.Upsih = function () {
    ...
    LatexCmds.Gamma = LatexCmds.Delta = LatexCmds.Theta = LatexCmds.Lambda = LatexCmds.Xi = LatexCmds.Pi = LatexCmds.Sigma = LatexCmds.Phi = LatexCmds.Psi = LatexCmds.Omega = LatexCmds.forall = function (
        latex
    ) {
    ...
    var PlusMinus = /** @class */ (function (_super) {
        ...
        class_7.prototype.sharedSiblingMethod = function (_opts, dir) {
            ...
            this.domFrag().oneElement().className = isBinaryOperator(this) ? "dcg-mq-binary-operator" : "";
            return this;
        };
        return class_7;
    })(BinaryOperator);
    ...
    LatexCmds["\u00b1"] = LatexCmds.pm = LatexCmds.plusmn = LatexCmds.plusminus = function () {
        return new PlusMinus("\\pm ", h.entityText("&plusmn;"), "plus-or-minus");
    };
    LatexCmds.mp = LatexCmds.mnplus = LatexCmds.minusplus = function () {
        return new PlusMinus("\\mp ", h.entityText("&#8723;"), "minus-or-plus");
    };
    CharCmds["*"] = LatexCmds.sdot = LatexCmds.cdot = bindBinaryOperator("\\cdot ", "&middot;", "*", "times"); //semantically should be &sdot;, but &middot; looks better
    ...
    LatexCmds["\u2264"] = LatexCmds.le = LatexCmds.leq = function () {
        return new Inequality(less, false);
    };
    LatexCmds["\u2265"] = LatexCmds.ge = LatexCmds.geq = function () {
        return new Inequality(greater, false);
    };
    LatexCmds.infty = LatexCmds.infin = LatexCmds.infinity = bindVanillaSymbol("\\infty ", "&infin;", "infinity");
    ...
    LatexCmds["\u00f7"] = LatexCmds.div = LatexCmds.divide = LatexCmds.divides = bindBinaryOperator(
        "\\div ",
        "&divide;",
        "[/]",
        "over"
    ...
    var Style = /** @class */ (function (_super) {
        ...
        function Style(ctrlSeq, tagName, attrs, ariaLabel, opts) {
            ...
            _this_1.mathspeakTemplate = ["Start" + _this_1.ariaLabel + ",", "End" + _this_1.ariaLabel];
    ...
    LatexCmds.mathrm = /** @class */ (function (_super) {
        ...
        function mathrm() {
            return (
                _super.call(this, "\\mathrm", "span", { class: "dcg-mq-roman dcg-mq-font" }, "Roman Font", {
    ...
    LatexCmds.mathit = function () {
        return new Style("\\mathit", "i", { class: "dcg-mq-font" }, "Italic Font");
    };
    LatexCmds.mathbf = function () {
        return new Style("\\mathbf", "b", { class: "dcg-mq-font" }, "Bold Font");
    };
    LatexCmds.mathsf = function () {
        return new Style("\\mathsf", "span", { class: "dcg-mq-sans-serif dcg-mq-font" }, "Serif Font");
    };
    LatexCmds.mathtt = function () {
        return new Style("\\mathtt", "span", { class: "dcg-mq-monospace dcg-mq-font" }, "Math Text");
    };
    //text-decoration
    LatexCmds.underline = function () {
        return new Style("\\underline", "span", { class: "dcg-mq-non-leaf dcg-mq-underline" }, "Underline");
    };
    LatexCmds.overline = LatexCmds.bar = function () {
        return new Style("\\overline", "span", { class: "dcg-mq-non-leaf dcg-mq-overline" }, "Overline");
    };
    ...
    LatexCmds.overarc = function () {
        return new Style("\\overarc", "span", { class: "dcg-mq-non-leaf dcg-mq-overarc" }, "Over Arc");
    };
    LatexCmds.dot = function () {
        return new MathCommand(
            "\\dot",
            new DOMView(1, function (blocks) {
                return h("span", { class: "dcg-mq-non-leaf" }, [
                    h("span", { class: "dcg-mq-dot-recurring-inner" }, [
                        h("span", { class: "dcg-mq-dot-recurring" }, [h.text(U_DOT_ABOVE)]),
                        h.block("span", { class: "dcg-mq-empty-box" }, blocks[0]),
                    ]),
                ]);
            })
        );
    ...
    LatexCmds.textcolor = /** @class */ (function (_super) {
        ...
        class_9.prototype.setColor = function (color) {
            ...
            this.domView = new DOMView(1, function (blocks) {
                return h.block("span", { class: "dcg-mq-textcolor", style: "color:" + color }, blocks[0]);
            });
        ...
        class_10.prototype.parser = function () {
            ...
            return Parser.optWhitespace
                ...
                .then(function (cls) {
                    _this_1.cls = cls || "";
                    _this_1.domView = new DOMView(1, function (blocks) {
                        return h.block("span", { class: "dcg-mq-class ".concat(cls) }, blocks[0]);
                    });
    ...
    var SupSub = /** @class */ (function (_super) {
        ...
        SupSub.prototype.addBlock = function (block) {
            if (this.supsub === "sub") {
                ...
                block.setDOM(
                    domFrag(h("span", { class: "dcg-mq-sup" }))
                ...
                block.setDOM(
                    domFrag(h("span", { class: "dcg-mq-sub" }))
                        .append(block.domFrag().children())
                ...
                NodeBase.linkElementByBlockNode(block.domFrag().oneElement(), block);
                this.domFrag().append(
                    domFrag(h("span", { style: "display:inline-block;width:0" }, [h.text(U_ZERO_WIDTH_SPACE)]))
                );
            }
            ...
            for (var i = 0; i < 2; i += 1)
                (function (cmd, supsub, oppositeSupsub, updown) {
                    ...
                    cmdSubSub.deleteOutOf = function (dir, cursor) {
                        ...
                        if (supsub === "sub") {
                            cmd.domFrag().addClass("dcg-mq-sup-only").children().last().remove();
                        }
                        this.remove();
                    };
    ...
    var SubscriptCommand = /** @class */ (function (_super) {
        ...
        function SubscriptCommand() {
            ...
            _this_1.supsub = "sub";
            _this_1.domView = new DOMView(1, function (blocks) {
                return h("span", { class: "dcg-mq-supsub dcg-mq-non-leaf" }, [
                    h.block("span", { class: "dcg-mq-sub" }, blocks[0]),
    ...
    LatexCmds.superscript = LatexCmds.supscript = LatexCmds["^"] = /** @class */ (function (_super) {
        __extends(SuperscriptCommand, _super);
        function SuperscriptCommand() {
            var _this_1 = (_super !== null && _super.apply(this, arguments)) || this;
            _this_1.supsub = "sup";
            _this_1.domView = new DOMView(1, function (blocks) {
                return h("span", { class: "dcg-mq-supsub dcg-mq-non-leaf dcg-mq-sup-only" }, [
                    h.block("span", { class: "dcg-mq-sup" }, blocks[0]),
                ]);
            });
            _this_1.textTemplate = ["^(", ")"];
    ...
    var SummationNotation = /** @class */ (function (_super) {
        ...
        function SummationNotation(ch, symbol, ariaLabel) {
            ...
            var domView = new DOMView(2, function (blocks) {
                return h("span", { class: "dcg-mq-large-operator dcg-mq-non-leaf" }, [
                    h("span", { class: "dcg-mq-to" }, [h.block("span", {}, blocks[1])]),
                    h("big", {}, [h.text(symbol)]),
                    h("span", { class: "dcg-mq-from" }, [h.block("span", {}, blocks[0])]),
                ]);
            });
    ...
    LatexCmds["\u2211"] = LatexCmds.sum = LatexCmds.summation = function () {
        return new SummationNotation("\\sum ", U_NARY_SUMMATION, "sum");
    };
    LatexCmds["\u220f"] = LatexCmds.prod = LatexCmds.product = function () {
    ...
    LatexCmds["\u222b"] = LatexCmds["int"] = LatexCmds.integral = /** @class */ (function (_super) {
        ...
        function class_11() {
            ...
            _this_1.domView = new DOMView(2, function (blocks) {
                return h("span", { class: "dcg-mq-int dcg-mq-non-leaf" }, [
                    h("big", {}, [h.text(U_INTEGRAL)]),
                    h("span", { class: "dcg-mq-supsub dcg-mq-non-leaf" }, [
                        h("span", { class: "dcg-mq-sup" }, [h.block("span", { class: "dcg-mq-sup-inner" }, blocks[1])]),
                        h.block("span", { class: "dcg-mq-sub" }, blocks[0]),
                        h("span", { style: "display:inline-block;width:0" }, [h.text(U_ZERO_WIDTH_SPACE)]),
                    ]),
                ]);
    ...
    //console.log(LatexCmds);
    //console.log(window);
    var Fraction = (LatexCmds.frac = LatexCmds.dfrac = LatexCmds.cfrac = LatexCmds.fraction = /** @class */ (function (
        _super
    ) {
        ...
        function FracNode() {
            ...
            _this_1.domView = new DOMView(2, function (blocks) {
                return h("span", { class: "dcg-mq-fraction dcg-mq-non-leaf" }, [
                    h.block("span", { class: "dcg-mq-numerator" }, blocks[0]),
                    h.block("span", { class: "dcg-mq-denominator" }, blocks[1]),
                    h("span", { style: "display:inline-block;width:0" }, [h.text(U_ZERO_WIDTH_SPACE)]),
                ]);
            });
            _this_1.textTemplate = ["(", ")/(", ")"];
        ...
        FracNode.prototype.mathspeak = function (opts) {
            ...
            if ((!opts || !opts.ignoreShorthand) && intRgx.test(numText) && intRgx.test(denText)) {
        ...
        FracNode.prototype.getFracDepth = function () {
            ...
            var walkUp = function (item, level) {
                if (item instanceof MQNode && item.ctrlSeq && item.ctrlSeq.toLowerCase().search("frac") >= 0)
                    level += 1;
    ...
    var LiveFraction = (LatexCmds.over = CharCmds["/"] = /** @class */ (function (_super) {
        ...
        class_12.prototype.createLeftOf = function (cursor) {
            if (!this.replacedFragment) {
                ...
                if (leftward instanceof SummationNotation && leftward[R] instanceof SupSub) {
                    ...
                    if (leftwardR instanceof SupSub && leftwardR.ctrlSeq != leftward.ctrlSeq) leftward = leftward[R];
                }
    ...
    var AnsBuilder = function () {
        return new MQSymbol("\\operatorname{ans}", h("span", { class: "dcg-mq-ans" }, [h.text("ans")]), "ans");
    };
    LatexCmds.ans = AnsBuilder;
    var PercentOfBuilder = function () {
        return new MQSymbol(
            "\\%\\operatorname{of}",
            h("span", { class: "dcg-mq-nonSymbola dcg-mq-operator-name" }, [h.text("% of ")]),
            "percent of"
        );
    };
    ...
    var SquareRoot = /** @class */ (function (_super) {
        ...
        function SquareRoot() {
            ...
            _this_1.domView = new DOMView(1, function (blocks) {
                return h("span", { class: "dcg-mq-non-leaf dcg-mq-sqrt-container" }, [
                    h("span", { class: "dcg-mq-scaled dcg-mq-sqrt-prefix" }, [SVG_SYMBOLS.sqrt.html()]),
                    h.block("span", { class: "dcg-mq-non-leaf dcg-mq-sqrt-stem" }, blocks[0]),
                ]);
            });
    ...
    LatexCmds.hat = /** @class */ (function (_super) {
        ...
        function Hat() {
            ...
            _this_1.domView = new DOMView(1, function (blocks) {
                return h("span", { class: "dcg-mq-non-leaf" }, [
                    h("span", { class: "dcg-mq-hat-prefix" }, [h.text("^")]),
                    h.block("span", { class: "dcg-mq-hat-stem" }, blocks[0]),
                ]);
            });
    ...
    var NthRoot = /** @class */ (function (_super) {
        ...
        function NthRoot() {
            var _this_1 = (_super !== null && _super.apply(this, arguments)) || this;
            _this_1.domView = new DOMView(2, function (blocks) {
                return h("span", { class: "dcg-mq-nthroot-container dcg-mq-non-leaf" }, [
                    h.block("sup", { class: "dcg-mq-nthroot dcg-mq-non-leaf" }, blocks[0]),
                    h("span", { class: "dcg-mq-scaled dcg-mq-sqrt-container" }, [
                        h("span", { class: "dcg-mq-sqrt-prefix dcg-mq-scaled" }, [SVG_SYMBOLS.sqrt.html()]),
                        h.block("span", { class: "dcg-mq-sqrt-stem dcg-mq-non-leaf" }, blocks[1]),
                    ]),
                ]);
            });
            _this_1.textTemplate = ["sqrt[", "](", ")"];
    ...
    var DiacriticAbove = /** @class */ (function (_super) {
        ...
        function DiacriticAbove(ctrlSeq, html, textTemplate) {
            ...
            var domView = new DOMView(1, function (blocks) {
                return h("span", { class: "dcg-mq-non-leaf" }, [
                    h("span", { class: "dcg-mq-diacritic-above" }, [html]),
                    h.block("span", { class: "dcg-mq-diacritic-stem" }, blocks[0]),
                ]);
            });
    ...
    var DelimsNode = /** @class */ (function (_super) {
        ...
        DelimsNode.prototype.setDOM = function (el) {
            ...
            var children = this.domFrag().children();
            if (!children.isEmpty()) {
                this.delimFrags = ((_c = {}), (_c[L] = children.first()), (_c[R] = children.last()), _c);
            }
            return this;
        };
        return DelimsNode;
    ...
    var Bracket = /** @class */ (function (_super) {
        ...
        function Bracket(side, open, close, ctrlSeq, end) {
            ...
            _this_1.side = side;
            _this_1.sides =
                ((_c = {}), (_c[L] = { ch: open, ctrlSeq: ctrlSeq }), (_c[R] = { ch: close, ctrlSeq: end }), _c);
            return _this_1;
        }
                    ...
                    [
                        h(
                            "span",
                            {
                                ...
                                class:
                                    "dcg-mq-scaled dcg-mq-bracket-l dcg-mq-paren" +
                                    (_this_1.side === R ? " dcg-mq-ghost" : ""),
                            },
                            [leftSymbol.html()]
                        ),
                        h.block(
                        ...
                        h(
                            "span",
                            {
                                ...
                                class:
                                    "dcg-mq-scaled dcg-mq-bracket-r dcg-mq-paren" +
                                    (_this_1.side === L ? " dcg-mq-ghost" : ""),
                            },
                            [rightSymbol.html()]
                        ),
                    ]
        ...
        Bracket.prototype.unwrap = function () {
            this.getEnd(L).children().disown().adopt(this.parent, this, this[R]).domFrag().insertAfter(this.domFrag());
            this.remove();
        };
        Bracket.prototype.deleteSide = function (side, outward, cursor) {
            ...
            if (this.matchBrack(opts, side, this.getEnd(L).getEnd(this.side))) {
                ...
                if (this.matchBrack(opts, side, this.parent.parent)) {
                    ...
                    this.delimFrags[L].removeClass("dcg-mq-ghost");
                    this.delimFrags[R].removeClass("dcg-mq-ghost");
                    var brackFrag = this.delimFrags[side].addClass("dcg-mq-ghost");
                ...
                if (sib) {
                    ...
                    leftEnd.domFrag().removeClass("dcg-mq-empty");
                ...
                else outward ? cursor.insDirOf(side, this) : cursor.insAtDirEnd(side, this.getEnd(L));
            }
        };
        ...
        Bracket.prototype.finalizeTree = function () {
            ...
            this.finalizeTree = this.intentionalBlur = function () {
                this.delimFrags[this.side === L ? R : L].removeClass("dcg-mq-ghost");
                this.side = 0;
            };
        };
    ...
    var Binomial = /** @class */ (function (_super) {
        ...
        function Binomial() {
            ...
            _this_1.domView = new DOMView(2, function (blocks) {
                return h("span", { class: "dcg-mq-non-leaf dcg-mq-bracket-container" }, [
                    h(
                        "span",
                        {
                    ...
                    h(
                        ...
                        [
                            h("span", { class: "dcg-mq-array dcg-mq-non-leaf" }, [
    ...
    var MathFieldNode = /** @class */ (function (_super) {
        ...
        function MathFieldNode() {
            ...
            _this_1.domView = new DOMView(1, function (blocks) {
                return h("span", { class: "dcg-mq-editable-field" }, [
                    h.block("span", { class: "dcg-mq-root-block", "aria-hidden": "true" }, blocks[0]),
                ]);
            });
            return _this_1;
        }
        ...
        MathFieldNode.prototype.finalizeTree = function (options) {
            ...
            // MathQuill applies aria-hidden to .dcg-mq-root-block containers
            ...
            function pushDownAriaHidden(node) {
                if (node.parentNode && !domFrag(node).hasClass("dcg-mq-root-block")) {
    ...
    CharCmds["\\"] = /** @class */ (function (_super) {
        ...
        function LatexCommandInput() {
            ...
            _this_1.ctrlSeq = "\\";
            _this_1.domView = new DOMView(1, function (blocks) {
                return h("span", { class: "dcg-mq-latex-command-input-wrapper dcg-mq-non-leaf" }, [
                    h("span", { class: "dcg-mq-latex-command-input dcg-mq-non-leaf" }, [
                        h.text("\\"),
                        h.block("span", {}, blocks[0]),
                    ]),
                ]);
        ...
        LatexCommandInput.prototype.createBlocks = function () {
            ...
            endsL.focus = function () {
                this.parent.domFrag().addClass("dcg-mq-hasCursor");
                if (this.isEmpty()) this.parent.domFrag().removeClass("dcg-mq-empty");
                return this;
            };
            endsL.blur = function () {
                this.parent.domFrag().removeClass("dcg-mq-hasCursor");
                if (this.isEmpty()) this.parent.domFrag().addClass("dcg-mq-empty");
                return this;
            };
            endsL.write = function (cursor, ch) {
                cursor.show().deleteSelection();
        ...
        LatexCommandInput.prototype.createLeftOf = function (cursor) {
            ...
            if (this._replacedFragment) {
                ...
                this._replacedFragment.domFrag().addClass("dcg-mq-blur");
