/* eslint-disable */
import { remap } from '../utils/commandMap';
...
export default function (replacements) {
    ...
    var NodeBase = /** @class */ (function () {
        ...
        NodeBase.prototype.shouldIgnoreSubstitutionInSimpleSubscript = function (options) {
            ...
            if (!this.parent.domFrag().hasClass('dcg-mq-sub'))
                return false;
            return true;
        };
    ...
    function getInterface(v) {
        ...
        var AbstractMathQuill = /** @class */ (function (_super) {
            ...
            AbstractMathQuill.prototype.mathquillify = function (classNames) {
                ...
                root.setDOM(domFrag(h('span', { class: 'dcg-mq-root-block', 'aria-hidden': true }))
                    .appendTo(el)
                    .oneElement());
    ...
    var Controller_focusBlur = /** @class */ (function (_super) {
        ...
        function Controller_focusBlur() {
            ...
            _this_1.handleWindowBlur = function () {
                ...
                if (_this_1.cursor.selection)
                    _this_1.cursor.selection.domFrag().addClass('dcg-mq-blur');
                _this_1.blur();
                _this_1.updateMathspeak();
            };
            return _this_1;
    ...
    var Controller_scrollHoriz = /** @class */ (function (_super) {
        ...
        Controller_scrollHoriz.prototype.setOverflowClasses = function () {
            ...
            if (root.classList.contains('dcg-mq-editing-overflow-right') !==
                shouldHaveOverflowRight)
                root.classList.toggle('dcg-mq-editing-overflow-right');
            if (root.classList.contains('dcg-mq-editing-overflow-left') !==
    ...
    var BinaryOperator = /** @class */ (function (_super) {
        ...
        function BinaryOperator(ctrlSeq, html, text, mathspeak, treatLikeSymbol) {
            ...
            if (treatLikeSymbol) {
                ...
                _this_1 = _super.call(this, ctrlSeq, h('span', { class: 'dcg-mq-binary-operator' }, html ? [html] : []), text, mathspeak) || this;
            }
            return _this_1;
        }
    ...
    var TextBlock = /** @class */ (function (_super) {
        ...
        TextBlock.prototype.html = function () {
            var out = h('span', { class: 'dcg-mq-text-mode' }, [
        ...
        LatexCmds.italic =
            LatexCmds.italics =
                LatexCmds.emph =
                    LatexCmds.textit =
                        LatexCmds.textsl =
                            makeTextBlock('\\textit', 'Italic', 'i', { class: 'dcg-mq-text-mode' });
    LatexCmds.strong =
        LatexCmds.bold =
            LatexCmds.textbf =
                makeTextBlock('\\textbf', 'Bold', 'b', { class: 'dcg-mq-text-mode' });
    LatexCmds.sf = LatexCmds.textsf = makeTextBlock('\\textsf', 'Sans serif font', 'span', { class: 'dcg-mq-sans-serif dcg-mq-text-mode' });
    LatexCmds.tt = LatexCmds.texttt = makeTextBlock('\\texttt', 'Mono space font', 'span', { class: 'dcg-mq-monospace dcg-mq-text-mode' });
    ...
    */
    ...
    var Digit = /** @class */ (function (_super) {
        ...
        function Digit(ch, mathspeak) {
            return _super.call(this, ch, h('span', { class: 'dcg-mq-digit' }, [h.text(ch)]), undefined, mathspeak) || this;
        }
        ...
        Letter.prototype.autoUnItalicize = function (opts) {
            ...
            new Fragment(lR || this.parent.getEnd(L), rL || this.parent.getEnd(R)).each(function (el) {
                if (el instanceof Letter) {
                    el.italicize(true)
                        .domFrag()
                        .removeClass('dcg-mq-first dcg-mq-last dcg-mq-followed-by-supsub');
                ...
                for (var len = min(autoOpsLength, str.length - i); len > 0; len -= 1) {
                    ...
                    if (autoOps.hasOwnProperty(word)) {
                        ...
                        if (!this.shouldOmitPadding(first[L]))
                            first.domFrag().addClass('dcg-mq-first');
                        if (!this.shouldOmitPadding(last[R])) {
                            if (last[R] instanceof SupSub) {
                                ...
                                last
                                    .domFrag()
                                    .toggleClass('dcg-mq-last', !(last[R] instanceof Bracket));
                            }
                        }
                        i += len - 1;
                        first = last;
    ...
    LatexCmds.mathrm = /** @class */ (function (_super) {
        ...
        function mathrm() {
            return _super.call(this, '\\mathrm', 'span', { class: 'dcg-mq-roman dcg-mq-font' }, 'Roman Font', {
    ...
    LatexCmds.overrightarrow = function () {
        return new Style('\\overrightarrow', 'span', { class: 'dcg-mq-non-leaf dcg-mq-overarrow dcg-mq-arrow-right' }, 'Over Right Arrow');
    };
    LatexCmds.overleftarrow = function () {
        return new Style('\\overleftarrow', 'span', { class: 'dcg-mq-non-leaf dcg-mq-overarrow dcg-mq-arrow-left' }, 'Over Left Arrow');
    };
    LatexCmds.overleftrightarrow = function () {
        return new Style('\\overleftrightarrow ', 'span', { class: 'dcg-mq-non-leaf dcg-mq-overarrow dcg-mq-arrow-leftright' }, 'Over Left and Right Arrow');
    };
    ...
    var SupSub = /** @class */ (function (_super) {
        ...
        SupSub.prototype.addBlock = function (block) {
            if (this.supsub === 'sub') {
                ...
                block.setDOM(domFrag(h('span', { class: 'dcg-mq-sup' }))
                ...
                block.setDOM(domFrag(h('span', { class: 'dcg-mq-sub' }))
                    .append(block.domFrag().children())
    ...
    var PercentOfBuilder = function () {
        return new MQSymbol('\\%\\operatorname{of}', h('span', { class: 'dcg-mq-nonSymbola dcg-mq-operator-name' }, [h.text('% of ')]), 'percent of');
    };
        ...
        function SquareRoot() {
            ...
            _this_1.domView = new DOMView(1, function (blocks) {
                return h('span', { class: 'dcg-mq-non-leaf dcg-mq-sqrt-container' }, [
                    h('span', { class: 'dcg-mq-scaled dcg-mq-sqrt-prefix' }, [
            ...
            _this_1.domView = new DOMView(2, function (blocks) {
                return h('span', { class: 'dcg-mq-nthroot-container dcg-mq-non-leaf' }, [
                    ...
                    h('span', { class: 'dcg-mq-scaled dcg-mq-sqrt-container' }, [
                        h('span', { class: 'dcg-mq-sqrt-prefix dcg-mq-scaled' }, [
                            SVG_SYMBOLS.sqrt.html(),
                        ]),
    ...
    var Bracket = /** @class */ (function (_super) {
        ...
        Bracket.prototype.html = function () {
            ...
            this.domView = new DOMView(1, function (blocks) {
                ...
                'span', { class: 'dcg-mq-non-leaf dcg-mq-bracket-container' }, [
                    h('span', {
    ...
    remap(LatexCmds, replacements, bindVanillaSymbol);
    ...
    CharCmds['\\'] = /** @class */ (function (_super) {
        ...
        LatexCommandInput.prototype.createBlocks = function () {
            ...
            endsL.focus = function () {
                this.parent.domFrag().addClass('dcg-mq-hasCursor');
                if (this.isEmpty())
                    this.parent.domFrag().removeClass('dcg-mq-empty');
                return this;
            };
            endsL.blur = function () {
                this.parent.domFrag().removeClass('dcg-mq-hasCursor');
                if (this.isEmpty())
                    this.parent.domFrag().addClass('dcg-mq-empty');
                return this;
            };
            endsL.write = function (cursor, ch) {
                cursor.show().deleteSelection();
