// // @ts-nocheck
// /* eslint-disable */
// export default function extendMathQuill() {
//     var __extends =
//             (this && this.__extends) ||
//             (function () {
//                 var t = function (e, n) {
...
//                 match =
//                     (_c =
//                         (_b = match === null || match === void 0 ? void 0 : match.parentElement) !== null &&
//                         _b !== void 0
//                             ? _b
...
//                 if (handler) {
//                     var APIClass =
//                         handlers === null || handlers === void 0 ? void 0 : handlers.APIClasses[this.KIND_OF_MQ];
...
//         LatexCmds.Q = LatexCmds.rationals = LatexCmds.Rationals = bindVanillaSymbol(
//             '\\mathbb{Q}',
//             '&#8474;',
//             'rationals'
//         );
...
//             'alef sym'
//         );
//         LatexCmds.xist = LatexCmds.xists = LatexCmds.exist = LatexCmds.exists = bindVanillaSymbol( //LOL
//             '\\exists ',
//             '&exist;',
...
//                 return (
//                     _super.call(this, ch, h('span', { class: 'dcg-mq-digit' }, [h.text(ch)]), undefined, mathspeak) ||
//                     this
//                 );
//             }
...
//         LatexCmds.Upsilon = LatexCmds.Upsi = LatexCmds.upsih = LatexCmds.Upsih = function () { //LaTeX //Elsevier and 9573-13 //W3C/Unicode "upsilon with hook" //'cos it makes sense to me
//             return new MQSymbol(
//                 '\\Upsilon ',
...
//             function Approx() {
//                 return (
//                     _super.call(this, '\\approx ', h.entityText('&approx;'), '\u2248', 'approximately equal') || this
//                 );
//             }
...
//                             h('span', { class: 'dcg-mq-sup' }, [
//                                 h.block('span', { class: 'dcg-mq-sup-inner' }, blocks[1]),
//                             ]),
//                             h.block('span', { class: 'dcg-mq-sub' }, blocks[0]),
//                             h('span', { style: 'display:inline-block;width:0' }, [h.text(U_ZERO_WIDTH_SPACE)]),
//                         ]),
